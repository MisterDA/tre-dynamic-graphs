...
\begin{figure}[!h]
  ...
  \subfloat[Temps \(3\)]{
    \begin{tikzpicture}[node/.style={circle, draw, minimum size=1cm]},
      ...
      \path (c) edge (d);
    \end{tikzpicture}}
  \caption{Graphe dynamique}\label{fig:dyn_graph}
\end{figure}
...
Le problème se pose lors de la construction de l'arbre de la
figure~\ref{fig:tree_bug} des plus courts chemins du graphe de la
figure~\ref{fig:graph_bug}. Dans \(T_2\), on découvre pour la première
...
\mint{text}|a 0.000000 -> c 1.000000 -> d 2.000000|
